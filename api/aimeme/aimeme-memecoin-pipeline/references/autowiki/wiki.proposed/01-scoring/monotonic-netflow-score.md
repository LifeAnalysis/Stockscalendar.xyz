...
id: 10
category: scoring
function: Score Netflow Monotonicity
status: active
related: [35, 40, 24]
---
...
- DerivedFrom [[aggregate-vs-instantaneous-meta-rule]] — applies meta-rule to netflow timeframes.
- DerivedFrom [[wash-vs-real-velocity]] — netflow monotonicity asks the same "is the most recent window real" question on Nansen netflow endpoints that wash-vs-real asks on DexScreener m5 buyers.
- Supports [[wash-vs-real-velocity]] — reciprocal: 15m netflow positivity is the netflow-side confirmation of the m5-unique-buyer signal.
