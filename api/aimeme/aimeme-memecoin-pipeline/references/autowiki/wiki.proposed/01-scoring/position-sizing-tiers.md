...
id: 11
category: scoring
function: Size By Tier Conviction
status: active
related: [12, 13, 22, 32]
---
...
- Implements [[sm-exit-pattern]] — "top SM full exit" is the uniform hard-exit trigger applied across all tiers.
- DerivedFrom [[sm-conviction-floor]] — S-tier promotion gate ("convicted SM ≥3 OR SM>10% pool") rests on the SM-non-negotiable rule.
- Supports [[lp-locked-tristate]] — D-tier explicitly conditions on "LP locked"; tristate scoring decides eligibility.
...
- Extends [[sm-conviction-recency]] — convicted SM ≥3 is the gate that promotes 4/4 from A to S tier.
