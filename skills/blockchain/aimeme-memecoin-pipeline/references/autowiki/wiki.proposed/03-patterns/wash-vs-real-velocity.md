...
id: 35
category: patterns
function: Distinguish Wash From Real Velocity
status: active
related: [40, 10, 24]
---
...
- DerivedFrom [[aggregate-vs-instantaneous-meta-rule]] — instantiates the meta-rule on inflow_fdv_ratio vs m5 buyers.
- Supports [[monotonic-netflow-score]] — m5 unique buyers and 15m netflow positivity are the same "is the most recent window real" question on adjacent endpoints.
