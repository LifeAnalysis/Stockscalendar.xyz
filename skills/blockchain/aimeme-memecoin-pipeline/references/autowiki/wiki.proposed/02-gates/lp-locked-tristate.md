...
id: 22
category: gates
function: Gate LP Lock With Tri-State
status: active
related: [31, 20, 24, 11]
---
# LP-Locked Tri-State
...
- Implements [[cheap-gate-ordering]] — Rugcheck LP read is free and runs before Nansen; tri-state LP is the canonical example cited there.
- DerivedFrom [[../pipeline.md]] v3.8 changelog item 2: "LP locked tri-state — unknown ≠ unlocked (fixes UniV4 false-negatives like uPEG)".
- Predates [[pump-fun-lp-zero-default]] — that proposed page extends tristate to the Solana post-graduation case; reciprocal link.
