...
id: 20
category: gates
function: Order Free Gates Before Paid
status: active
related: [22, 23, 21, 12]
---
# Cheap-Gate Ordering
...
- Supports [[sm-conviction-floor]] — the FROGE story is the cost-ordering preamble to the SM-non-negotiable conclusion; same cycle, same evidence, two ends of the same gate sequence.
- Supports [[drained-pool-honeypot]] — NYANDOG is the cheap-gate canonical reject and the drained-pool canonical instance simultaneously.
- DerivedFrom [[aggregate-vs-instantaneous-meta-rule]] — m5 sells/sellers ratio is itself an aggregate-vs-instantaneous check that runs free.
- Extends [[top-holder-dumping]] and [[lp-locked-tristate]] — both are cheap-tier hard gates that must execute before any paid step.
